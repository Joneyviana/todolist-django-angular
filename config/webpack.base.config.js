...
module.exports = (opts) => {
  ...
  return {
    ...
    entry: {
      main: path.resolve(PROJECT_ROOT, 'todolist/static/todolist/index'),
      vendor: ['react', 'redux', 'react-router', 'react-redux', 'react-dom'],
    },

    output: {
      path: path.resolve(PROJECT_ROOT, 'todolist/static/todolist/bundles'),
    ...
    resolve: {
      extensions: ['', '.js', '.jsx'],
      modules: [
        path.resolve(PROJECT_ROOT, 'todolist/static/todolist'),
        'node_modules',
      ],
    },
  };
